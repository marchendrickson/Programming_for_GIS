...
import zipfile             #This package we will use to unzip the files
...
for filename in os.listdir("."):
    ...
    if filename.endswith(".zip"):
		...
		output_raster = temp_workspace + name + str(counter)
...
for raster in IMGList:
	...
	if pixelType == "9":
		...
		arcpy.CopyRaster_management(raster, filename, "", "", "", "", "", "32_BIT_FLOAT")
...
arcpy.gp.Hillshade_sa("..\Final_Proj\IMG_Times", Default_Hillshade, "315", "45", "NO_SHADOWS", "1") #This is where we create our hillshade
