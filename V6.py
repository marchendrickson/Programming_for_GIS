...
'''
shadowHillshade = arcpy.gp.Hillshade_sa("..\Final_Proj\IMG_Times.tif", Default_Hillshade, "315", "45", "SHADOWS", "1") #This is where we create our hillshade with shadows
shadowHillshade.save( temp_workspace + "shadow_hillshade.tif")
print "Hillshade with Shadows Done!"
'''
